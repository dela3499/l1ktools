...
%                 sc = mkgctstruct;
            ...
            if arg.censor_bad
                ...
                count_cv = cell2mat({str2num(char(combods.cdesc(:, combods.cdict('count_cv'))))});
                count_mean = cell2mat({str2num(char(combods.cdesc(:, combods.cdict('count_mean'))))});
